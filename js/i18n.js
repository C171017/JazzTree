...
const EN = {
  ...
  'service.listen': 'Listen to {artist} – {title}', 'service.spotify': 'Search on Spotify', 'service.appleMusic': 'Search on Apple Music', 'service.netease': 'Open in NetEase Cloud Music (网易云音乐)',
